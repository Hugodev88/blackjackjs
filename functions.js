...
function ganhou() {
    statusDoJogo.innerHTML = "Voce ganhou." 
}

function empate() {
    statusDoJogo.innerHTML = "Voce empatou." 
}

function perdeu() {
    statusDoJogo.innerHTML = "Voce perdeu." 
}

function atualizarVisor(){

    if (parou == 1){
        visorCartasMesa.innerHTML = cartasMesa
        visorCartasMesaTotal.innerHTML = contarCartas(cartasMesa)
    }
   
    visorCartasJogador.innerHTML = cartasJogador
